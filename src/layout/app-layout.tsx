...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['hospital-administrator', 'medical-staff', 'it-support-staff'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Hospitals', path: '/hospitals', entity: 'hospital', service: AccessServiceEnum.PROJECT, icon: FiHome },
