  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Hospital Management Application: Streamlining Day-to-Day Operations for Hospitals, Offering Effective and Efficient Management Solutions"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxob3NwaXRhbHxlbnwwfHx8fDE2OTg0MDU1MzV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Hospital Management Application: Streamlining Day-to-Day Operations for Hospitals, Offering Effective and Efficient Management Solutions`}
            </Text>
            <Box
